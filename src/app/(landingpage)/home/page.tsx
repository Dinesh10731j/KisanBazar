...
import { ShoppingCart, Handshake, Truck, Leaf, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <>
      ...
      <main className="relative min-h-screen flex flex-col">
        ...
        <section className=" px-3 bg-gradient-to-r from-[#ff8a00] to-[#e52e71] py-16 text-center">
          <h2 className="text-3xl font-bold mb-6 text-white">Why Choose KisanBazar?</h2>
