...
const About = () => {
  return (
   ...
   <Header/>
    <div className=" mx-auto p-8 bg-gradient-to-r from-[#ff8a00] to-[#e52e71] ">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-white mt-20">About KisanBazar</h1>
        <p className="mt-2 text-lg text-gray-200">Connecting farmers directly with customers for fresh and fair trade.</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 ">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-200">At KisanBazar, our goal is to connect customers directly with farmers, ensuring farm-fresh products, supporting local agriculture, and cutting out the middleman.</p>
        </div>
      </div>
      ...
      <div className="mt-12 text-center">
        ...
        <p className="mt-2 text-gray-200">Be a part of KisanBazar and support local farmers. Start shopping today!</p>
        <Button>
